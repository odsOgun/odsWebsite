...
const Exhibitor = () => {
  return (
    <div>
      ...
      {/* Hero */}
      <div className=" h-[552px] shrink-0                                    lg:w-[100%] lg:h-[618px] object-contain bg-[url('src/assets/img/Stagex.png')]">
        ...
        <button className='flex  font-[inter] font-semibold text-sm rounded ml-[16px]  pt-[10px] pr-[12px] pb-[10px] pl-[12px] lg:ml-[60px] lg:mt-[100px] mt-[118px]  bg-[#ACFAAC] w-[155px]'>
          Join Exhibitors <img className='' src={keyboard_arrow_right} alt='arrowdownicon' />
        </button>
      </div>
      {/* Meet Our Exhibitors */}
      <div className=' h-[946px]                        lg:w-[100%] lg:h-[812px] bg-[#101611]'>
        <h2 className=' h-[40px] font-[Platypi] font-semibold text-[#F2F9FF] pl-[16px]     lg:pl-[60px] pt-[100px] text-3xl  leading-10 tracking-tighter'>
          Meet Our Exhibitors
        </h2>
        ...
        <div className='hidden lg:block'>
          <div className=' flex flex-wrap justify-between align-center ml-[60px] mr-[60px] mt-[48px]'>
            <div>
              <img src={Grazacblue} alt='grazaccard' />
            </div>
            <div>
            ...
            <div>
              <img src={techeconomycard} alt='techenomycard' />
            </div>
          </div>
        ...
        <div className=' lg:hidden'>
          <div className='flex justify-between align-center mt-[32px] '>
            <div className='w-[50%] ml-[16px] mr-[16px]'>
              <img src={smallgrazac} alt='mobilegrazaccard' />
            </div>
            <div className='w-[50%] ml-[16px] mr-[16px]'>
              <img src={smallgrazac1} alt='mobilegrazaccard' />
            </div>
          </div>
          <div className='flex justify-between align-center '>
            ...
            <div className='w-[50%] ml-[16px] mr-[16px]'>
              <img src={smalltechnoeconomy} alt='mobiletecheconomycard' />
            </div>
          </div>
          <div className='flex justify-between align-center '>
            <div className='w-[50%] ml-[16px] mr-[16px]'>
              <img src={smallogundaily} alt='mobileogundailycard' />
            </div>
            <div className='w-[50%] ml-[16px] mr-[16px]'>
              <img src={capsafex} alt='mobileafexcard' />
            </div>
          </div>
          <div className='flex justify-between align-center '>
            <div className='w-[50%] ml-[16px] mr-[16px]'>
      ...
      {/*Leading Companies  */}
      <div className=' h-[1,296px]   lg:w-[100%] lg:h-[766px] bg-[#101611] pt-[100px]'>
        ...
        <div className='flex  flex-wrap  justify-center align-center  ml-[20px] mr-[20px] lg:ml-[60px] lg:mr-[60px] mt-[32px]'>
          ...
          <div>
            <img src={facestar} alt='staricon' />
            <h4 className=' mt-[8px] text-[#F2F9FF] font-[inter] font-semibold text-lg leading-6  tracking-wide'>
              Have Fun and Unwind
            </h4>
            <p className=' h-[88px] lg:w-[544px] lg:h-[66px] text-[#B0C5D6] text-sm font-normal'>
