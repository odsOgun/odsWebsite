...
const MobileApp = () => {
  return (
    <div className='p-20 px-5 md:px-40 md:py-[100px] changePadding '>
      <div className='flex flex-col items-center justify-center w-full md:flex-row md:justify-between md:items-start md:gap-[90px] max-w-[1120px] mx-auto my-0 '>
        <div>
          <div className='flex flex-col gap-4 w-full max-w-[335px] md:max-w-[558px] '>
            ...
            <p className='text-center text-[#627587] text-sm leading-[22px] tracking-[0.2px] font-normal md:text-base md:text-left '>
              The ODS 24 Mobile App is your all-in-one tool for an immersive tech experience at your
              fingertip. Connect with like minds like never before
            </p>
          </div>
