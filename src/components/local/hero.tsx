      ...
      <div className='max-w-[713px] mx-auto pt-[100px]'>
        <div className='flex flex-col gap-8'>
          ...
          <p className='text-base font-normal tracking-[0.2px] text-[#627587] text-center'>
            Ogun Digital Summit 2024 is focused on improving collaborations, paving the way for new
            innovations and igniting conversation towards technology advancements and prosperity for
            Nigeria's digital technology ecosystem.
          </p>
